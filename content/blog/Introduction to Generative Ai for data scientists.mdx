...
description: Mulai dari type, pengertian dan lain sebagainya
date: 2024-07-21
...
Generative models are a type of statistical model used in machine learning that aim to learn the true data distribution of the training set so as to generate new data points with some variations. These models are able to generate new data that mimic the distribution of the training data.
...
Generative models have a variety of applications. In the field of art and design, they are used to create new images, designs, and even music. In scientific research, they can generate synthetic data for studies or help design new molecules for drug discovery. The potential of generative models is vast and continues to grow as the technology advances.
### 1. Bayesian Models
