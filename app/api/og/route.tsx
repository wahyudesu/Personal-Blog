...
export async function GET(req: NextRequest) {
  try {
    ...
    const paint = "black"; // Misalnya, sesuaikan dengan nilai yang sesuai

    const mode = "dark"; // Misalnya, sesuaikan dengan mode yang sesuai

    const fontSize = heading.length > 100 ? "70px" : "100px"

    const values = {
      type: "Your Type Here", // Sesuaikan dengan tipe yang sesuai
    };
      ...
      (
        ...
        >
          ...
          <div className="flex flex-col flex-1 py-10">
            ...
            <div
              className="flex leading-[1.1] text-[80px] font-bold"
              style={{
                fontFamily: "Cal Sans",
                fontWeight: "bold",
                marginLeft: "-3px",
          ...
          <div className="flex items-center w-full justify-between">
            ...
            <div
              ...
              style={{ fontFamily: "Inter", fontWeight: "normal" }}
            >
              <div className="flex ml-2">{siteConfig.links.github}</div>
            </div>
          </div>
        </div>
      ),
